...
with open('name.basics.tsv', encoding="utf8") as name:
    # Omit header
    name.readline()
...
with open('title.basics.tsv', encoding="utf8") as title:
    # Omit header
    title.readline()
...
with open('title.ratings.tsv', encoding="utf8") as ratings:
    # Omit header
    ratings.readline()
...
with open('title.principals.tsv', encoding="utf8") as principals:
    # Omit header
    principals.readline()
